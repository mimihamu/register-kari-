...
class V139AutoBackupScheduleTest {
    ...
    fun productSourcesExposeDesignatedWeekdayAndSettlementToggle() {
        ...
        assertTrue(scheduler.contains("settlementAutoBackupEnabled"))
        assertTrue(scheduler.indexOf("settlementAutoBackupEnabled") < scheduler.indexOf("uniqueZWorkName(settlementId)"))
