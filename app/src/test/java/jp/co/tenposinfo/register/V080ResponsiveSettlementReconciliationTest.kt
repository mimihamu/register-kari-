...
class V080ResponsiveSettlementReconciliationTest {
    ...
    fun responsiveHistoryWiresV078ComparisonAndV079AppendOnlyAudit() {
        ...
        assertTrue(build.contains("versionCode = 110"))
        assertTrue(build.contains("versionName = \"0.80.0-dev.1\""))
        assertTrue(workflow.contains("V080ResponsiveSettlementReconciliationTest.kt"))
        assertTrue(workflow.contains("TSUGUREGI_v0.80.0_dev1_responsive_settlement_reconciliation_debug.apk"))
