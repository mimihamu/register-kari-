...
class V044GoogleDriveAccountTest {
    ...
    fun posAccountAuthorizationIsWiredWithoutPersistingAccessToken() {
        ...
        assertFalse(easyConnect.contains("putString(\"access_token\""))
        assertFalse(easyConnect.contains("putString(\"refresh_token\""))
        ...
        assertTrue(build.contains("versionCode = 99"))
        assertTrue(build.contains("versionName = \"0.69.0-dev.1\""))
        ...
        assertTrue(workflow.contains("TSUGUREGI_v0.69.0_dev1_sale_receipt_reprint_operations_ledger_debug.apk"))
    }
}