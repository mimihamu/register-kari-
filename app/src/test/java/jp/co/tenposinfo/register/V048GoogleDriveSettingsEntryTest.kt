...
class V048GoogleDriveSettingsEntryTest {
    ...
    fun visibleAdministratorMenuOpensDriveAndSyncScreen() {
        ...
        assertTrue(workflow.contains("TSUGUREGI_v0.53.0_dev1_drive_sync_verification_recovery_debug.apk"))
        assertTrue(workflow.contains("TSUGUREGI-v0.53.0-dev1-drive-sync-verification-recovery-apks"))
