            ...
            if (compact) {
                Column(
                    ...
                    SettlementInputPanelV030(
                        ...
                        onExecute = {
                            if (isZ) showConfirmation = true else onExecute(actual, "", false)
                        },
                    )
