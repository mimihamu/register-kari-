...
class V043DriveConnectionTest {
    ...
    fun inspectorUiDocsAndWorkflowStayConnected() {
        ...
        assertTrue(registerBuild.contains("versionCode = 79"))
        assertTrue(registerBuild.contains("versionName = \"0.49.0-dev.1\""))
        assertTrue(plusBuild.contains("versionCode = 8"))
        assertTrue(plusBuild.contains("versionName = \"0.8.0-dev.1\""))
