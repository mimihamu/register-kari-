...
class V043DriveConnectionTest {
    ...
    fun inspectorUiDocsAndWorkflowStayConnected() {
        ...
        assertTrue(registerBuild.contains("versionCode = 84"))
        assertTrue(registerBuild.contains("versionName = \"0.54.0-dev.1\""))
        assertTrue(plusBuild.contains("versionCode = 13"))
        assertTrue(plusBuild.contains("versionName = \"0.13.0-dev.1\""))
