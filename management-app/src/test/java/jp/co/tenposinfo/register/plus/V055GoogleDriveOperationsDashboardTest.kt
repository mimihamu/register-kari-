...
class V055GoogleDriveOperationsDashboardTest {
    ...
    fun operationsDashboardKeepsRetriesSafeAndAuditable() {
        ...
        assertTrue(runtime.contains("IMMEDIATE_NAME = \"tsuguregi-plus-drive-api-sync-immediate\""))
        assertTrue(runtime.contains("startupStates = immediateStates"))
        assertTrue(runtime.contains("manualStates = immediateStates"))
        assertFalse(runtime.contains("tsuguregi-plus-drive-api-sync-startup"))
        assertFalse(runtime.contains("tsuguregi-plus-drive-api-sync-manual"))
